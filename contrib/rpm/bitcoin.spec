...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 9234
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 9234
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19234
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 9234
	%{_sbindir}/semanage port -d -p tcp 18332
	%{_sbindir}/semanage port -d -p tcp 19234
